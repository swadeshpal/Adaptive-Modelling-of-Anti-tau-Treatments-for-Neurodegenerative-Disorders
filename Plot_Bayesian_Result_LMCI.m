...
nsample = 5000;
[Y_Min, Y_Max] = MinMax(nsample, chain, myFile_LMCI);
time   = data.ydata(:,1);
dt = 0.01;
...
for i=1:3
    subplot(3,1,i)
    hold on
    scatter(time,myFile_LMCI(i+1,:),sz,'MarkerEdgeColor',[0 .5 .5],...
...
print -dpng Fig_BR2.png -r500
print -depsc Fig_BR2.eps -r500    