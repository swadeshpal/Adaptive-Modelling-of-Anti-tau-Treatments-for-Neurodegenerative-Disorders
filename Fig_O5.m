...
plot(t,x2,'-m','DisplayName','$$v$$ (2-year)','LineWidth',1.5)
plot(t,x3,'-.r','LineWidth',1.5,'DisplayName','$w$ (2-year)')
set(gca,'FontSize',12)
% xlabel('time (years)')
...
load Control_t0_56_tf_61.mat

%  legend()
%   hold on
plot(t,x2,'--k','LineWidth',1.5,'DisplayName','$v$ (5-year)')
plot(t,x3,':b','LineWidth',1.5,'DisplayName','$w$ (5-year)')
set(gca,'FontSize',12)
...
print -depsc Fig_O5.eps -r500
print -dpng Fig_O5.png -r500
