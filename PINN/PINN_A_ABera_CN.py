...
theta = np.array(
    [0.074, 0.00008147, 0.105, 0.003514, 0.188, 23.036, 8.235, 0.00004018, 0.00439, 0.0000656, 0.00009813, 1514.308,
     8.914, 3.723])

time_np = np.arange(56.2, 93.59, 0.01)
...
theta_df.to_csv('PINN_CN_out_theta.txt', sep='\t', encoding='utf-8', index=False, header=True)
